...
var timerModule = angular.module('timer', [])
  .directive('timer', ['$compile', 'GameFactory', '$rootScope', function ($compile, GameFactory, $rootScope) {
    return  {
      restrict: 'EA',
      replace: false,
      scope: {
      ...
      controller: ['$scope', '$element', '$attrs', '$timeout', 'I18nService', '$interpolate', function ($scope, $element, $attrs, $timeout, I18nService, $interpolate) {
        ...
        var tick = function tick() {
          ...
          if ($scope.countdown > 0) {
            ...
            GameFactory.passedCount++
            if(GameFactory.passedCount > 2){
              GameFactory.computerTakeover().then(function(){
